...
#Region "Connect to db"
    ...
    Private Sub TempConnectToDefaultDb()
...
#End Region
    ...
    Private Sub CreateTimeLineDB(worker As BackgroundWorker, inputs As CreateTimeLineDBInputs)
        ...
        Try
            ...
            ' TODO - za novi eRevisionType = CreateIfNew omoguciti ucitavanje body-a iz fajla .sql
            ' TODO - napraviti prozor za hotfix naredbi s generiranjem infa tko je odradio i sto. Slati info na mail.
            ' TODO - generirati prije i poslije skriptu pri akciji rollback i ugraditi neki winmerge
